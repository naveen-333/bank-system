...
customerNames = ['Ram Charan','NTR','Raja Mouli','Keeravani','Chandrabose']
customerPins = ['1122','3344','5566','7788','9900']
customerBalances = [50000,48000,100000,90000,30000]
deposit = 0
withdrawal = 0
balance = 0
counter_1 = 1
...
while True:
    ...
    choiceNumber = input("Select your option from the above menu : ")
    if choiceNumber == "1":
        ...
        j = 0
        print("option 2 is selected by the customer")
